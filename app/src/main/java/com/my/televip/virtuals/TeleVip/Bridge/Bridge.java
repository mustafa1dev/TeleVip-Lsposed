...
public class Bridge {
    ...
    public static Object getLayoutManager(Context context){
        return XReflect.callStaticMethod(ClassLoad.getClass(ClassNames.SETTINGS_ADAPTER, DexInjector.classLoader), "getLayoutManager", context);
    }

    public static void init(SettingsController settingsController){
        if (DexInjector.classLoader == null) return;
        try {
            Class<?> bridgeClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.Bridge", DexInjector.classLoader);
            Class<?> textCheckCellClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.SettingsAdapter$TextCheckCellHolder", DexInjector.classLoader);
            Class<?> expandableTextCheckCellClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.SettingsAdapter$ExpandableTextCheckCellHolder", DexInjector.classLoader);
            Class<?> textSettingsCellClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.SettingsAdapter$TextSettingsCellHolder", DexInjector.classLoader);
            Class<?> headerCellClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.SettingsAdapter$HeaderCellHolder", DexInjector.classLoader);
            Class<?> shadowSectionCellClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.SettingsAdapter$ShadowSectionCellHolder", DexInjector.classLoader);
            Class<?> textInfoCellClass = XReflect.findClassIfExists("com.televip.SettingsAdapter.SettingsAdapter$TextInfoCellHolder", DexInjector.classLoader);

            HMethod.hookMethod(bridgeClass, "getRow", int.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
            ...
            HMethod.hookConstructor(textCheckCellClass, View.class, Object.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
            ...
            HMethod.hookConstructor(expandableTextCheckCellClass, View.class, Object.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
            ...
            HMethod.hookConstructor(textSettingsCellClass, View.class, Object.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
            ...
            HMethod.hookConstructor(headerCellClass, View.class, Object.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
            ...
            HMethod.hookConstructor(shadowSectionCellClass, View.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
            ...
            HMethod.hookConstructor(textInfoCellClass, View.class, new AbstractMethodHook() {
                @Override
                protected void beforeMethod(AbstractMethodHook.MethodHookParam param) {
