...
public class Logger {
    ...
    public static void e(Throwable throwable) {
        ...
        try {
            PackageManager pm = loadClass.getApplicationContext().getPackageManager();
            PackageInfo info = pm.getPackageInfo(loadClass.getApplicationContext().getPackageName(), 0);
